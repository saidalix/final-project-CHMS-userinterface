    ...
    <div class="center_content">
      ...
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
          ...
          <form method="POST" action="connectcon.php">
            <div class="form_row">
              <label class="contact"><strong>Name:</strong></label>
              <input type="text" class="contact_input" name="Full_name" id="Full_name" />
            </div>
            <div class="form_row">
            ...
            <div class="form_row">
              ...
              <input type="text" class="contact_input" name="company" id="company" />
            </div>
            <div class="form_row">
              <label class="contact"><strong>Message:</strong></label>
              <textarea class="contact_textarea" name="message" id="message"></textarea>
            </div>
            <div class="form_row">
