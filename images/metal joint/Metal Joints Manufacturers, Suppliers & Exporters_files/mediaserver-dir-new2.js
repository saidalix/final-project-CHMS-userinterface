...
function serve_ad(mycompid, callback)
{
	...
	{
	    mediaserver_ad_url = 'https://media4trade.indiamart.com/mediaserver-dir?';
...
// 	    mediaserver_pageurl = 'http://dir.indiamart.com/';
	    ...
	    mediaserver_ad_url += '&location5=' + mediaserver_location5;
	    ...
	    mediaserver_ad_url += '&size5=' + mediaserver_size5;
	    ...
	    ({
			...
			if(typeof(s["5"]) != 'undefined' && s["5"] != null)
			{ 
				banner5 = s["5"].banner;
				target_url5 = s["5"].target_url;
				size5 = s["5"].size;
				location5 = s["5"].location;
			}
			callback.call(null,banner1,target_url1,size1,location1,banner2,target_url2,size2,location2,banner3,target_url3,size3,location3,banner4,target_url4,size4,location4,banner5,target_url5,size5,location5);
		    },
	...
	else
	{
		...
		{
		    mediaserver_ad_url = 'https://media4trade.indiamart.com/prdservernewm4t-new?';
		    mediaserver_size = mediaserver_width+'x'+mediaserver_height;
		    mediaserver_pageurl;
		    if(mediaserver_parentwindow == 1)
		    {
