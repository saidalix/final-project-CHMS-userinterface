...
<div id="main_container">
  ...
  <?php include ("header.php"); ?>
    ...
    <div class="center_content">
      <div class="center_title_bar">Payement</div>
      <div class="prod_box_big">
        <div class="top_prod_box_big"></div>
        <div class="center_prod_box_big">
          <div class="contact_form">
          <form method="POST" action="connectpay.php">
            <div class="form_row">
            ...
            <div class="form_row">
              <label class="contact"><strong>Occupation:</strong></label>
              <input type="text" class="contact_input" name="Occupation" id="Occupation" />
            </div>
            <div class="form_row">
              <label class="contact"><strong>Medium for Payement:</strong></label>
              <input type="text" class="contact_input" name="Mpayement" id="Mpayement" />
            </div>
            <div class="form_row">
              <label class="contact"><strong>Item Names:</strong></label>
              <input type="text" class="contact_input" name="Item_name" id="Item_name" />
            </div>
            <div class="form_row">
              <label class="contact"><strong>Amount:</strong></label>
              <input type="text" class="contact_input" name="amount" id="amount" />
            </div>
           <div class="form_row">
